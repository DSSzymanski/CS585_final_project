...
def train(args):
    ...
    # Set the model
    model = CharLevelConvNet(input_length=args.max_length, n_classes=training_set.num_classes,
                             input_dim=len(args.alphabet), n_conv_filters=args.n_conv_filters,
    ...
    for epoch in range(args.num_epochs):
        ...
        if test_metrics["acc"] > best_accuracy:
            ...
            torch.save(model, os.path.join(args.output, "char_level_balanced_model"))
